            ...
            <div class="col-md-4">
                <div class="card h-100">
                    <div class="card-body text-center">
                        <h3>Harga Terbaik</h3>
                        <p>Dapatkan harga tiket pesawat terbaik untuk perjalanan Anda</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100">
                    <div class="card-body text-center">
                        <h3>Mudah & Cepat</h3>
                        <p>Proses pemesanan yang mudah dan cepat dengan berbagai pilihan pembayaran</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100">
                    <div class="card-body text-center">
                        <h3>24/7 Support</h3>
                        <p>Layanan pelanggan 24 jam untuk membantu perjalanan Anda</p>
                    </div>
                </div>
            </div>
        </div>
