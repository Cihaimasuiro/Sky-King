...
<head>
    ...
    <title>Booking - Airline Booking</title>
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="passenger_id[]" required
                            ...
                            <div class="payment-method mb-4">
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="radio" name="payment_method" id="credit_card" value="Kartu Kredit">
